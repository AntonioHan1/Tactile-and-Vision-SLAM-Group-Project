...
pred_deltas = np.load('../checkpoints_12_5_6dof/new_pred_deltas_ordered.npy')
pose_deltas = np.load('../checkpoints_12_5_6dof/new_pose_deltas_ordered.npy')
# pred= np.load('../checkpoints_12_5_6dof/new_pred_poses_ordered.npy')
# pose = np.load('../checkpoints_12_5_6dof/new_gt_pose_ordered.npy')
gs_image_times = np.load('../checkpoints_12_5_6dof/new_gs_image_times.npy')
...
gs_image_times = np.linspace(0, 25, len(pred_deltas))
ax = plt.gca()
...
plt.savefig('../checkpoints_12_5_6dof/odom_preddeltas_x_pos_ordered.png')
plt.close()
# print(pose.shape)
# pred = pred[0:len(pose), :]
# print(pred.shape)
# gs_image_times = np.linspace(0, 25, len(pred))
...
# plt.subplots_adjust(left=0.2, bottom=0.25, top=0.85, right=0.95)
# plt.legend(loc='lower left', fontsize=40)
# plt.savefig('../checkpoints_12_5_6dof/odom_pose_x_pos_ordered.png')
# plt.close()
# plt.figure(figsize=(30, 15))
...
# plt.subplots_adjust(left=0.2, bottom=0.25, top=0.85, right=0.95)
# plt.legend(loc='lower left', fontsize=40)
# plt.savefig('../checkpoints_12_5_6dof/odom_pose_x_rot_ordered.png')
# plt.close()
# plt.figure(figsize=(30, 15))
...
# plt.subplots_adjust(left=0.2, bottom=0.25, top=0.85, right=0.95)
# plt.legend(loc='lower left', fontsize=40)
# plt.savefig('../checkpoints_12_5_6dof/odom_pose_y_pos_ordered.png')
# plt.close()
# plt.figure(figsize=(30, 15))
...
# plt.subplots_adjust(left=0.2, bottom=0.25, top=0.85, right=0.95)
# plt.legend(loc='lower left', fontsize=40)
# plt.savefig('../checkpoints_12_5_6dof/odom_pose_y_rot_ordered.png')
# plt.close()
# plt.figure(figsize=(30, 15))
...
# plt.subplots_adjust(left=0.2, bottom=0.25, top=0.85, right=0.95)
# plt.legend(loc='lower left', fontsize=40)
# plt.savefig('../checkpoints_12_5_6dof/odom_pose_z_pos_ordered.png')
# plt.close()
# plt.figure(figsize=(30, 15))
...
# plt.subplots_adjust(left=0.2, bottom=0.25, top=0.85, right=0.95)
# plt.legend(loc='lower left', fontsize=40)
# plt.savefig('../checkpoints_12_5_6dof/odom_pose_z_rot_ordered.png')
# plt.close()
plt.figure(figsize=(30, 15))
ax = plt.gca()
...
plt.subplots_adjust(left=0.2, bottom=0.25, top=0.85, right=0.95)
plt.legend(loc='lower left', fontsize=40)
plt.savefig('../checkpoints_12_5_6dof/odom_preddeltas_y_pos_ordered.png')
plt.close()
...
plt.subplots_adjust(left=0.2, bottom=0.25, top=0.85, right=0.95)
plt.legend(loc='lower left', fontsize=40)
plt.savefig('../checkpoints_12_5_6dof/odom_preddeltas_z_pos_ordered.png')
plt.close()
...
plt.subplots_adjust(left=0.2, bottom=0.25, top=0.85, right=0.95)
plt.legend(loc='lower left', fontsize=40)
plt.savefig('../checkpoints_12_5_6dof/odom_preddeltas_x_rot_ordered.png')
plt.close()
...
plt.subplots_adjust(left=0.2, bottom=0.25, top=0.85, right=0.95)
plt.legend(loc='lower left', fontsize=40)
plt.savefig('../checkpoints_12_5_6dof/odom_preddeltas_y_rot_ordered.png')
plt.close()
...
plt.subplots_adjust(left=0.2, bottom=0.25, top=0.85, right=0.95)
plt.legend(loc='lower left', fontsize=40)
plt.savefig('../checkpoints_12_5_6dof/odom_preddeltas_z_rot_ordered.png')
plt.close()